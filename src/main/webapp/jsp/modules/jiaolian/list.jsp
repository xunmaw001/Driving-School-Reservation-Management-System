...
<!--/Pre Loader -->
    ...
    <!-- 本表的查询条件 -->
        ...
        function setDataRow(item, number) {
            ...
            //工号
            var jiaolianUuidNumberCell = document.createElement('td');
            jiaolianUuidNumberCell.innerHTML = item.jiaolianUuidNumber;
            row.appendChild(jiaolianUuidNumberCell);
            ...
            //电子邮箱
            var jiaolianEmailCell = document.createElement('td');
            jiaolianEmailCell.innerHTML = item.jiaolianEmail;
            row.appendChild(jiaolianEmailCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("jiaolian/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addjiaolian", "addjiaolian");
            window.location.href = "add-or-update.jsp"
        }
        ...
        function resetPassword(id) {
            http("jiaolian/resetPassword", "GET",{
                id:id
            }, (res) => {
                if(res.code == 0){
                    getDataList();
