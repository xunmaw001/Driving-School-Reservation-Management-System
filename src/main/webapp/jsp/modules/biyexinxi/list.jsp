...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">毕业信息管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">毕业信息列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">毕业信息列表</h3>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="biyexinxiNameSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="毕业信息名称" aria-controls="tableId">
                                        </div>
                                    </div>
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            //毕业信息名称
            var biyexinxiNameSearchInput = $('#biyexinxiNameSearch');
            if( biyexinxiNameSearchInput != null){
                if (biyexinxiNameSearchInput.val() != null && biyexinxiNameSearchInput.val() != '') {
                    searchForm.biyexinxiName = $('#biyexinxiNameSearch').val();
                }
            }
                            getDataList();
        }
        ...
        function getDataList() {
            http("biyexinxi/page", "GET", {
                ...
                biyexinxiDelete: 1,
                //本表的
                biyexinxiName: searchForm.biyexinxiName,
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            //毕业信息名称
            var biyexinxiNameCell = document.createElement('td');
            biyexinxiNameCell.innerHTML = item.biyexinxiName;
            row.appendChild(biyexinxiNameCell);


            //毕业时间
            var biyeTimeCell = document.createElement('td');
            biyeTimeCell.innerHTML = item.biyeTime;
            row.appendChild(biyeTimeCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("biyexinxi/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addbiyexinxi", "addbiyexinxi");
            window.location.href = "add-or-update.jsp"
        }
