            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">训练登记</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <input id="yonghuId" name="yonghuId" v-model="ruleForm.yonghuId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="xunlianName" name="xunlianName" class="form-control"
                                               v-model="ruleForm.xunlianName" readonly>
                                    </div>


                                <div class="form-group col-md-6">
                                    <label>训练类型</label>
                                    <input style="width: 450px" id="xunlianValue" name="xunlianValue" class="form-control"
                                           v-model="ruleForm.xunlianValue" readonly>
                                </div>
...
<script>
    ...
    function setContent() {
        ...
        if (ruleForm.xunlianContent != null && ruleForm.xunlianContent != 'null' && ruleForm.xunlianContent != '') {
            var xunlianContentUeditor = UE.getEditor('xunlianContentEditor');
                xunlianContentUeditor.ready(function () {
                    ...
                    xunlianContentUeditor.setDisabled('fullscreen');
            });
        }
    }
