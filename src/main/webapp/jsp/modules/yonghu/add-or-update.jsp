            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">编辑学员</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6 yonghuPhoneDiv">
                                        ...
                                        <input style="width: 450px" id="yonghuPhone" name="yonghuPhone" class="form-control"
                                               onchange="yonghuPhoneChickValue(this)"  placeholder="学员手机号">
                                    </div>
                                    <div class="form-group col-md-6 yonghuIdNumberDiv">
                                        ...
                                        <input style="width: 450px" id="yonghuIdNumber" name="yonghuIdNumber" class="form-control"
                                               onchange="yonghuIdNumberChickValue(this)"  placeholder="学员身份证号">
                                    </div>
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            ...
            messages: {
                ...
                yonghuName: "学员姓名不能为空",
                yonghuPhone: "学员手机号不能为空",
                yonghuIdNumber: "学员身份证号不能为空",
                yonghuPhoto: "学员头像不能为空",
                sexTypes: "性别不能为空",
