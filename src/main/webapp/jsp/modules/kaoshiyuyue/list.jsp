        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">考试预约管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">考试预约列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">考试预约列表</h3>
    ...
    <script>
        ...
        function setDataRow(item, number) {
            ...
            row.appendChild(kaoshiNameCell);
                    ...
                    //考试时间
            var kaoshiTimeCell = document.createElement('td');
            kaoshiTimeCell.innerHTML = item.kaoshiTime;
            row.appendChild(kaoshiTimeCell);
            ...
            //考试得分
            var kaoshiyuyueDefenCell = document.createElement('td');
            kaoshiyuyueDefenCell.innerHTML = item.kaoshiyuyueDefen;
            row.appendChild(kaoshiyuyueDefenCell);


            //考试结果
            var kaoshiyuyueTextCell = document.createElement('td');
            kaoshiyuyueTextCell.innerHTML = item.kaoshiyuyueText;
            row.appendChild(kaoshiyuyueTextCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("kaoshiyuyue/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addkaoshiyuyue", "addkaoshiyuyue");
            window.location.href = "add-or-update.jsp"
        }
