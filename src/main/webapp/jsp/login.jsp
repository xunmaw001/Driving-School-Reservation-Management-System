        ...
        <form id="loginForm" action="" method="post" class="form">
            ...
            <div class="body-content">
				...
				<div class="form-group">
                    <div class="checkbox-list">
                        <label>
                            <input type="radio" name="chk" value="学员" onclick="checkRole('yonghu')">&nbsp;学员
                        </label>
                    </div>
                </div>
				<div class="form-group">
                    <div class="checkbox-list">
                        <label>
                            <input type="radio" name="chk" value="教练" onclick="checkRole('jiaolian')">&nbsp;教练
                        </label>
                    </div>
                </div>
				...
				<div class="form-group"><button type="button" class="btn btn-success"  style="width: 100%;background-color:var(--publicSubColor, #F37335);color: #FFFFFF;"  onclick="window.location.href='./modules/yonghu/register.jsp'">注册  学员</button></div>
				<%--<div class="form-group"><button type="button" class="btn btn-success"  style="width: 100%;background-color:var(--publicSubColor, #F37335);color: #FFFFFF;"  onclick="window.location.href='./modules/jiaolian/register.jsp'">注册  教练</button></div>--%>
